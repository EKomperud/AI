...
sentence(1).clauses = coordinate * percept(1);
sentence(2).clauses = (coordinate + 16) * percept(2);
sentence(3).clauses = (coordinate + 32) * percept(3);
sentence(4).clauses = (coordinate + 48) * percept(4);
sentence(5).clauses = (coordinate + 64) * percept(5);
